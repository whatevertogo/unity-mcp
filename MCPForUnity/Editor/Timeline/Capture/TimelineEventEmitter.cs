...
namespace MCPForUnity.Editor.Timeline.Capture
{
    ...
    ///
    /// Usage:
    ///   TimelineEventEmitter.EmitComponentAdded(component);
    ///   TimelineEventEmitter.EmitAssetImported(assetPath, assetType);
    /// </summary>
    public static class TimelineEventEmitter
    {
        /// <summary>
        ...
        public static void EmitComponentAdded(Component component)
        {
            if (component == null)
            {
                Debug.LogWarning("[TimelineEventEmitter] Attempted to emit ComponentAdded with null component");
                return;
            }
        ...
        public static void EmitComponentRemoved(Component component)
        {
            if (component == null)
            {
                Debug.LogWarning("[TimelineEventEmitter] Attempted to emit ComponentRemoved with null component");
                return;
            }
        ...
        public static void EmitGameObjectCreated(GameObject gameObject)
        {
            if (gameObject == null)
            {
                Debug.LogWarning("[TimelineEventEmitter] Attempted to emit GameObjectCreated with null GameObject");
                return;
            }
        ...
        public static void EmitAssetImported(string assetPath, string assetType = null)
        {
            ...
            {
                Debug.LogWarning("[TimelineEventEmitter] Attempted to emit AssetImported with null or empty path");
                return;
            }
        ...
        public static void EmitAssetDeleted(string assetPath)
        {
            if (string.IsNullOrEmpty(assetPath))
            {
                Debug.LogWarning("[TimelineEventEmitter] Attempted to emit AssetDeleted with null or empty path");
                return;
            }
        ...
        public static void EmitAssetMoved(string fromPath, string toPath)
        {
            ...
            {
                Debug.LogWarning("[TimelineEventEmitter] Attempted to emit AssetMoved with null or empty destination path");
                return;
            }
        ...
        private static void EmitEvent(string eventType, string targetId, Dictionary<string, object> payload)
        {
            ...
            {
                Debug.LogWarning($"[TimelineEventEmitter] Failed to emit {eventType} event: {ex.Message}");
            }
        }
